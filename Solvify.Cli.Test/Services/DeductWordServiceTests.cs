...
public class DeductWordServiceTests
{
    ...
    {
        // Arrange
        DeductWordService service = new(_defaultSetting, _defaultSetting.GameSettings.Single(x => x.Name == "6mal5"), ["böse"]);
    ...
    {
        // Arrange
        DeductWordService service = new(_defaultSetting, _defaultSetting.GameSettings.Single(x => x.Name == "6mal5"), ["Ödem"]);
    ...
    {
        // Arrange
        DeductWordService service = new(_defaultSetting, _defaultSetting.GameSettings.Single(x => x.Name == "6mal5"), ["Öäm"]);
